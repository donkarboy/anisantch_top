...
─────────────────────────────────────────────────────────
  {
    ...
    // Optional: skips / subtitles if found in the active iframe
    "skips":      [...],
    "subtitles":  [...],
  }
...
def build_flat_entry(
    ...
    Optional meta keys (only when found in iframe HTML):
        skips, subtitles
    """
    ...
    # ── 3. Optional meta (skips / subtitles) ─────────────────────
    if "skips" in meta:
        entry["skips"] = meta["skips"]
